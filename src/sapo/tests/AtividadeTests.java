...
class AtividadeTests extends BaseTest {
	...
	void testCadastrarAtividade() {
		assertEquals("VRT-2", this.atividadeController.cadastrarAtividade("Ver Tiktok",
				"Gastar toda da internet móvel assistindo tiktok", "124.123.754-12"));
	}

	@Test
	void testEncerrarAtividade() {
		this.atividadeController.cadastrarAtividade("Ver Tiktok", "Gastar toda da internet móvel assistindo tiktok",
				"124.123.754-12");
